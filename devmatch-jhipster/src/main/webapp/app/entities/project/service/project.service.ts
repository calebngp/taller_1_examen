...
type RestOf<T extends IProject | NewProject> = Omit<T, 'fechaCreacion' | 'fechaModificacion'> & {
...
export class ProjectService {
  ...
  protected convertDateFromClient<T extends IProject | NewProject | PartialUpdateProject>(project: T): RestOf<T> {
    return {
      ...project,
      fechaCreacion: project.fechaCreacion?.toJSON() ?? null,
      fechaModificacion: project.fechaModificacion?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restProject: RestProject): IProject {
    return {
      ...restProject,
      fechaCreacion: restProject.fechaCreacion ? dayjs(restProject.fechaCreacion) : undefined,
      fechaModificacion: restProject.fechaModificacion ? dayjs(restProject.fechaModificacion) : undefined,
    };
  }
