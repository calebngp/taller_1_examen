...
describe('Experience Management Detail Component', () => {
      ...
      providers: [
        provideRouter(
          [
            {
              path: '**',
              loadComponent: () => import('./experience-detail.component').then(m => m.ExperienceDetailComponent),
              resolve: { experience: () => of({ id: 18889 }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load experience on init', async () => {
      ...
      // THEN
      expect(instance.experience()).toEqual(expect.objectContaining({ id: 18889 }));
    });
  });
