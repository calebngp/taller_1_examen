...
import { DeveloperService, EntityArrayResponseType } from '../service/developer.service';
...
export class DeveloperComponent implements OnInit {
  ...
  protected readonly developerService = inject(DeveloperService);
  ...
  trackId = (item: IDeveloper): number => this.developerService.getDeveloperIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.developers.set(dataFromBody);
  }
