...
import { sampleWithRequiredData } from '../match-result.test-samples';
...
describe('MatchResult Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.matchResults()[0]).toEqual(expect.objectContaining({ id: 4914 }));
  });

  describe('trackId', () => {
    it('should forward to matchResultService', () => {
      const entity = { id: 4914 };
      jest.spyOn(service, 'getMatchResultIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMatchResultIdentifier).toHaveBeenCalledWith(entity);
